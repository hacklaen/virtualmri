...
/**
 * Diese Klasse erzeugt die Bedienelemente fuer eine gespoilte Gradientenechosequenz
 ...
 */
public class GESpoiledUI extends PulsesequenceUI {
	...
	/**
	 * Referenz auf die Berechnungsklasse der GESpoiled-Sequenz
	 */

	// private GESpoiled sequence;
	 ...
	 * 
	 */
	public GESpoiledUI() {}		// Standardkonstruktor
	...
	void jbInit() throws Exception {
		...
		ptrPanel = new SliderPanel(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("gespoiled.tr.title"), 5, 6005, java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("gespoiled.tr.unit"));
		ptrPanel.setBounds(new Rectangle(5, 5, 250, 70));
		ptrPanel.setToolTip(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("gespoiled.tr.tooltip"));
		...
		ptePanel = new SliderPanel(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("gespoiled.te.title"), 2, 1002, java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("gespoiled.te.unit"));
		ptePanel.setBounds(new Rectangle(5, 78, 250, 70));
		ptePanel.setToolTip(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("gespoiled.te.tooltip"));
		...
		pAngelPanel = new SliderPanel(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("gespoiled.flip.title"), 1, 181, java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("gespoiled.flip.unit"));
		pAngelPanel.setBounds(new Rectangle(5, 151, 250, 70));
		pAngelPanel.setToolTip(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("gespoiled.flip.tooltip"));
	...
	public void pbStart_actionPerformed(ActionEvent e) {
		if (ptePanel.getValue() < ptrPanel.getValue()) {
			...
			sequence = new GESpoiled();
			sequence.setUI(this);

			GESpoiled flsequence = (GESpoiled) sequence;
			...
			ErrorMessage.showMessage(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("gespoiled.exception.tetr"));
		} 
