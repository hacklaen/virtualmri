...
/**
 * Diese Klasse erzeugt die Bedienelemente fuer eine Saturation-Recovery-Sequenz
...
public class SaturationRecoveryUI extends PulsesequenceUI {
	...
	/**
	 * Schieberegler fuer die Repititionszeit.
	 */
	...
	/**
	 * Diese Methode fuegt die sequenzspezifischen Steuerelemente in den Darstellungsbereich
	...
	void jbInit() throws Exception {
		// th 2005.11.12
//		myPanel.setBackground(SystemColor.scrollbar);
		myPanel.setLayout(null);

		// Einrichten des Schiebereglers fuer die TR-Zeit
		ptrPanel = new SliderPanel(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("saturationrecoveryui.tr.title"), 100, 6100, java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("saturationrecoveryui.tr.unit"));
		ptrPanel.setBounds(new Rectangle(5, 5, 250, 70));
		ptrPanel.setToolTip(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("saturationrecoveryui.tr.tooltip"));
	...
	/**
	 * Die Methode setzt die Werte der Bedienelemente der Sequenz auf die in
	 * den entsprecheden Instanzvariablen gespeicherten Werte.
	 */
	...
	void pbStart_actionPerformed(ActionEvent e) {
		...
		// Auslesen der Parameter fuer die Sequenz
		srsequence.setTRTime(ptrPanel.getValue());

		// Erzeugen eines Intensitaetsbildes mit Hilfe der Sequenz
