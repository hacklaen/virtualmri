...
/**
 * Diese Klasse erzeugt die Bedienelemente fuer eine Flash-Sequenz und stellt
 * diese dar.
 * <DL><DT><B>Modifications: </B><DD>
 * tha 2000.05.14: Plausible Werte fuer Slider eingetragen. <br>
 ...
 */
public class FlashUI extends PulsesequenceUI {
	...
	/**
	 * Referenz auf die Berechnungsklasse der Flash-Sequenz
	 */

	// private Flash sequence;
	 ...
	 * 
	 */
	public FlashUI() {}		// Standardkonstruktor
	...
	void jbInit() throws Exception {
		...
		ptrPanel = new SliderPanel(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("flashui.tr.title"), 5, 6005, java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("flashui.tr.unit"));
		ptrPanel.setBounds(new Rectangle(5, 5, 250, 70));
		ptrPanel.setToolTip(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("flashui.tr.tooltip"));
		...
		ptePanel = new SliderPanel(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("flashui.te.title"), 2, 1002, java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("flashui.te.unit"));
		ptePanel.setBounds(new Rectangle(5, 78, 250, 70));
		ptePanel.setToolTip(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("flashui.te.tooltip"));
		...
		pAngelPanel = new SliderPanel(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("flashui.flip.title"), 1, 181, java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("flashui.flip.unit"));
		pAngelPanel.setBounds(new Rectangle(5, 151, 250, 70));
		pAngelPanel.setToolTip(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("flashui.flip.tooltip"));
	...
	public void pbStart_actionPerformed(ActionEvent e) {
		if (ptePanel.getValue() < ptrPanel.getValue()) {
			...
			ErrorMessage.showMessage(java.util.ResourceBundle.getBundle("virtual/mrt/sequences/resources/sequences_loc").getString("flashui.exception.tetr"));
		} 
