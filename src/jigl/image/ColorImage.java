...
public class ColorImage implements Image {
	 ...
	 * Set of 3 GrayImages
	 */
	protected GrayImage[]		plane = new GrayImage[3];
	...
	public ColorImage(int x, int y) {
		X = x;
		Y = y;
		plane[0] = new GrayImage(X, Y);
		plane[1] = new GrayImage(X, Y);
		plane[2] = new GrayImage(X, Y);
	}
	 ...
	 */
	public final GrayImage plane(int p) {
		return plane[p];
	} 


	/**
	 * Set the plane to a ColorImage pl<P>
	 * @param p the plane of this image
	 * @param pl ColorImage to set the plane to
	 * @return a shallow copy
	 */
	 ...
	 * @return this
	 */
	public final ColorImage add(int p, int v) {
	 ...
	 * @return this
	 */
	public final ColorImage subtract(int p, int v) {
	 ...
	 * @return this
	 */
	public final ColorImage multiply(int p, int v) {
	 ...
	 * @return this
	 */
	public final ColorImage divide(int p, int v) {
	...
	public final ColorImage diff(ColorImage im) {
		...
		plane[2] = plane[2].diff(im.plane(2));
		return this;
	} 


	/**
	 * Multiplies a ColorImage by this image
	...
	/**
	 * Divides this image by a ColorImage
	...
	/**
	 * Turns this image into a Java Image (java.awt.Image).	The ColorImage is assumed
	 * to be RGB. <P>
	 * @param none
	 ...
	 * @return three element array of integers
	 */
	public final int[] get(int x, int y, ROI r) {
		int[] color = new int[3];
	 ...
	 * @param r Region of Interest
	 */
	public final void add(int x, int y, int val0, int val1, int val2, ROI r) {
	 ...
	 * @param r Region of Interest
	 */
	public final void subtract(int x, int y, int val0, int val1, int val2, ROI r) {
	 ...
	 * @param r Region of Interest
	 */
	public final void multiply(int x, int y, int val0, int val1, int val2, ROI r) {
	 ...
	 * @param r Region of Interest
	 */
	public final void divide(int x, int y, int val0, int val1, int val2, ROI r) {
	 ...
	 * @return an integer containing the minimum value
	 */
	public final int min(int p, ROI r) {
	 ...
	 * @return an integer containing the maximum value
	 */
	public final int max(int p, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage add(int[] v, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage add(int val0, int val1, int val2, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage add(int p, int v, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage subtract(int[] v, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage subtract(int val0, int val1, int val2, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage subtract(int p, int v, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage multiply(int[] v, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage multiply(int val0, int val1, int val2, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage multiply(int p, int v, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage divide(int[] v, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage divide(int val0, int val1, int val2, ROI r) {
	 ...
	 * @return this
	 */
	public final ColorImage divide(int p, int v, ROI r) {
	...
	/**
	 * Adds a Region of Interest in another ColorImage to a Region of Interest of this image
	 * @param im the ColorImage to add
	 * @param sourceImage Region of Interest for the Source Image
	 * @param destImage Region of Interest for the Destination Image
	 * @return this
	 */
	public final ColorImage add(ColorImage im, ROI sourceImage, ROI destImage) {
	...
	/**
	 * Subtracts a Region of Interest from another ColorImage from a Region of Interest of this image
	 * @param im the ColorImage to subtract
	 * @param sourceImage Region of Interest for the Source Image
	 * @param destImage Region of Interest for the Destination Image
	 * @return this
	 */
	public final ColorImage subtract(ColorImage im, ROI sourceImage, ROI destImage) {
	...
	/**
	 * Multiplies a Region of Interest from another ColorImage by a Region of Interest of this image
	 * @param im the ColorImage to multiply
	 * @param sourceImage Region of Interest for the Source Image
	 * @param destImage Region of Interest for the Destination Image
	 * @return this
	 */
	public final ColorImage multiply(ColorImage im, ROI sourceImage, ROI destImage) {
	...
	/**
	 * Divides a Region of Interest in this image by a Region of Interest from another ColorImage
	 * @param im the ColorImage to divide
	 * @param sourceImage Region of Interest for the Source Image
	 * @param destImage Region of Interest for the Destination Image
	 * @return this
	 */
	public final ColorImage divide(ColorImage im, ROI sourceImage, ROI destImage) {
